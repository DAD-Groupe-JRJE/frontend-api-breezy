...
export default function OneTweet({ tweet }) {
    ...
    return (
        <article className="p-4 border-b border-gray-100 hover:bg-gray-50 transition-colors duration-200">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between mb-1">
                        ...
                        <Link href={`/user/${dummyUser.handle}`} className="group flex items-center gap-1 min-w-0">
                            <span className="font-bold text-gray-900 truncate group-hover:underline decoration-gray-900">
                                {dummyUser.name}
                            </span>
                    ...
                    <Link href={`/tweet/${tweet._id}`} className="block mt-1">
                        <p className="text-gray-900 text-base whitespace-pre-wrap break-words">
                            {tweet.content}
                        </p>
                    </Link>
                    ...
                    <div className="flex items-center gap-12 mt-3 text-gray-500">
                        ...
                        >
                            <div className={`p-2 rounded-full transition ${isCommented ? 'bg-blue-50' : 'group-hover:bg-blue-50'}`}>
                        ...
                        >
                            <div className={`p-2 rounded-full transition ${isLiked ? 'bg-pink-50' : 'group-hover:bg-pink-50'}`}>
